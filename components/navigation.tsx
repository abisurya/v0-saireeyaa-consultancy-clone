      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              href="/visa-quiz"
              className="flex items-center gap-1.5 px-4 py-2 bg-gradient-to-r from-yellow-400 to-orange-400 text-black font-bold text-sm rounded-full hover:from-yellow-300 hover:to-orange-300 transition-all shadow-sm"
            >
              ✨ Visa Quiz
            </Link>
          </div>
        ...
        {isMenuOpen && (
          ...
          >
            <div className="px-4 py-2 space-y-2">
              ...
              <Link href="/visa-quiz" className="block py-2 font-bold text-yellow-600 hover:text-yellow-500">
                ✨ Free Visa Quiz
              </Link>
            </div>
          </motion.div>
